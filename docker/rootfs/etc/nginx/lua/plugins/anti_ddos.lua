...
-- TODO: IMPROVE THIS!
local JavascriptPuzzleVars = [[parseInt("]] ..
                                 os.date("%Y%m%d", os.time() - 24 * 60 * 60) ..
                                 [[", 10) + parseInt("]] ..
                                 os.date("%d%m%Y", os.time() - 24 * 60 * 60) ..
                                 [[", 10)]] -- Javascript output of our two random numbers
local JavascriptPuzzleVars_answer =
    os.date("%Y%m%d", os.time() - 24 * 60 * 60) +
        os.date("%d%m%Y", os.time() - 24 * 60 * 60) -- lua output of our two random numbers
local JavascriptPuzzleVars_answer =
    math.floor(JavascriptPuzzleVars_answer + 0.5) -- fix bug removing the 0. decimal on the end of the figure
...
local ip_blacklist = {
    ...
    "107.189.64.0/18", "91.90.92.0/24", "198.245.48.0/20", "185.243.16.0/24",
    "217.182.0.0/16", "51.79.128.0/17", "103.5.12.0/22", "198.27.64.0/18",
    "46.105.200.0/24", "51.79.0.0/17", "2607:5300::/32", "144.217.0.0/16",
    "46.244.32.0/20", "46.105.201.0/24", "46.105.198.0/24", "54.39.0.0/16",
    "46.105.203.0/24", "51.81.128.0/17", "46.105.0.0/16", "51.178.0.0/16",
    "167.114.128.0/18", "91.90.88.0/24", "8.7.244.0/24", "139.99.128.0/17",
    "144.2.32.0/19", "51.38.0.0/16", "91.90.94.0/24", "8.33.128.0/21",
    "8.21.41.0/24", "216.32.194.0/24", "51.89.0.0/16", "5.196.0.0/16",
    "195.110.30.0/23", "51.195.0.0/16", "2001:41d0::/32", "91.90.93.0/24",
    "8.29.224.0/24", "167.114.192.0/19", "8.24.8.0/21", "91.90.90.0/24",
    "167.114.0.0/17", "91.121.0.0/16", "51.91.0.0/16", "139.99.0.0/17",
    "178.32.0.0/15", "8.26.94.0/24", "51.77.0.0/16", "91.90.89.0/24",
    "185.228.97.0/24", "151.80.0.0/16", "213.251.128.0/18", "149.56.0.0/16",
    "37.59.0.0/16", "213.186.32.0/19", "2402:1f00::/32", "193.70.0.0/17",
    "142.44.128.0/17", "51.161.0.0/17", "54.38.0.0/16", "185.228.98.0/24",
    "91.90.88.0/21", "216.32.220.0/24", "92.222.0.0/16", "147.135.128.0/17",
    "142.4.192.0/19", "5.135.0.0/16", "192.95.0.0/18", "46.105.202.0/24",
    "185.12.32.0/23", "145.239.0.0/16", "213.32.0.0/17", "37.187.0.0/16",
    "37.60.48.0/21", "198.100.144.0/20", "149.202.0.0/16", "94.23.0.0/16",
    "167.114.224.0/19", "193.109.63.0/24", "51.254.0.0/15", "91.90.91.0/24",
    "216.32.213.0/24", "216.32.218.0/24", "8.33.96.0/21", "5.39.0.0/17",
    "185.228.96.0/24", "164.132.0.0/16", "158.69.0.0/16", "46.105.199.0/24",
    "8.30.208.0/21", "54.37.0.0/16", "46.105.204.0/24", "2402:1f00:8100::/40",
    "87.98.128.0/17", "51.68.0.0/16", "37.60.56.0/21", "8.20.110.0/24",
    "51.83.0.0/16", "185.45.160.0/22", "216.32.192.0/24", "198.50.128.0/17",
    "205.218.49.0/24", "216.32.216.0/24", "51.75.0.0/16", "195.246.232.0/23",
    "91.90.95.0/24", "51.81.0.0/17", "2402:1f00:8000::/40", "23.92.224.0/19",
    "192.240.152.0/21", "91.134.0.0/16", "92.246.224.0/19", "176.31.0.0/16",
    "79.137.0.0/17", "193.104.19.0/24", "137.74.0.0/16", "192.99.0.0/16",
    "198.27.92.0/24", "147.135.0.0/17", "8.33.136.0/24", "2604:2dc0::/32",
    "8.33.137.0/24", "188.165.0.0/16", "66.70.128.0/17", "8.18.172.0/24",
    "185.228.99.0/24", "54.36.0.0/16", "8.18.128.0/24",
    -- ASN AS12876 ONLINE S.A.S. IP ranges
    "62.4.0.0/19", "151.115.0.0/18", "51.15.0.0/17", "163.172.208.0/20",
    "212.129.0.0/18", "2001:bc8::/32", "212.83.160.0/19", "212.47.224.0/19",
    "2001:bc8:1c00::/38", "51.158.128.0/17", "163.172.0.0/16",
    "212.83.128.0/19", "51.158.0.0/15", "195.154.0.0/16", "51.15.0.0/16",
    "62.210.0.0/16"
}
...
local user_agent_blacklist_table = {
    {"^$", 3}, -- blocks blank / empty user-agents
    {"Kodi", 1}, {"XBMC", 1}, {"curl", 1}, {"winhttp", 1}, {"HTTrack", 1},
    {"libwww-perl", 1}, {"python", 1}
}
...
local query_string_expected_args_only_table = {
    ...
    {
        "%/.*%.js", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.css", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.ico", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.jpg", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.jpeg", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.bmp", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.gif", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.xml", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.txt", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.png", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.swf", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.pdf", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.zip", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.rar", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.7z", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.woff2", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.woff", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.wof", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.eot", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.ttf", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.svg", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.ejs", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.ps", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.pict", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.webp", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.eps", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.pls", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.csv", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.mid", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.doc", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.ppt", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.tif", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.xls", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.otf", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.jar", {} -- no args to accept so any provided in the url will be removed.
    }, -- video file formats
    {
        "%/.*%.mp4", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.webm", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.ogg", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.flv", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.mov", {} -- no args to accept so any provided in the url will be removed.
    }, -- music file formats
    {
        "%/.*%.mp3", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.m4a", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.aac", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.oga", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.flac", {} -- no args to accept so any provided in the url will be removed.
    }, {
        "%/.*%.wav", {} -- no args to accept so any provided in the url will be removed.
    }
}
...
local query_string_remove_args_table = {
    {
        ...
        { -- query strings to remove to improve Cache HIT Ratios and Stop attacks / Cache bypassing and Busting.
            ...
            "_ga", "gclid", "utm_source", "utm_campaign", "utm_medium",
            "utm_expid", "utm_term", "utm_content",
            -- other cache busting query strings
            "cache", "caching", "age-verified", "ao_noptimize", "usqp",
            "cn-reloaded", "dos", "ddos", "lol", "rnd", "random", "v", -- some urls use ?v1.2 as a file version causing cache busting
            "ver", "version"
        }
    }, {
...
local custom_headers = {
    {
        ...
        "%/.*%.js", {
            {
                "Cache-Control",
                "max-age=315360000, stale-while-revalidate=315360000, stale-if-error=315360000, public, immutable"
            }, -- cache headers to save server bandwidth.
            {"Pragma", "public"}
        }
    }, {
        "%/.*%.css", {
...
if string.match(string.lower(host), ".onion") then remote_addr = "tor" end
if remote_addr == "tor" then remote_addr = tor_remote_addr end
...
local function query_string_remove_args()
    ...
    local query_string_remove_args_table_length =
        #query_string_remove_args_table
...
local function has_value(table_, val)
    for key, value in next, table_ do if value == val then return true end end
    return false
end
...
local function query_string_expected_args_only()
    ...
    local query_string_expected_args_only_table_length =
        #query_string_expected_args_only_table
...
local function ip_address_in_range(input_ip, client_connecting_ip)
    ...
    if string.match(input_ip, "%:") and string.match(client_connecting_ip, "%:") then -- if both input and connecting ip are ipv6 addresses
        -- ipv6
        ip_type = 1
    elseif string.match(input_ip, "%.") and
        string.match(client_connecting_ip, "%.") then -- if both input and connecting ip are ipv4 addresses
        -- ipv4
        ip_type = 2
    else
        return
    ...
    if ip_type == 1 then -- ipv6
        ...
        local function explode(string, divide)
            ...
            for st, sp in function()
                return string.find(string, divide, pos, true)
            end do
        ...
        for i = 1, ipbits_length do
            ...
            elseif v:len() < 4 then
                ...
                for i = 1, padding do ipbits[k] = 0 .. ipbits[k] end
            end
        end
        ...
        -- validate actual ip
        local a, b, clientip, mask_client =
            client_connecting_ip:find('([%w:]+)')
        ...
        local expanded_ip_count = (ipbits[1] or "0000") .. ':' ..
                                      (ipbits[2] or "0000") .. ':' ..
                                      (ipbits[3] or "0000") .. ':' ..
                                      (ipbits[4] or "0000") .. ':' ..
                                      (ipbits[5] or "0000") .. ':' ..
                                      ...
                                      (ipbits[7] or "0000") .. ':' ..
                                      (ipbits[8] or "0000")
        expanded_ip_count = ngx.re.gsub(expanded_ip_count, ":", "",
                                        ngx_re_options)

        local client_connecting_ip_count =
            (ipbits_client[1] or "0000") .. ':' .. (ipbits_client[2] or "0000") ..
                ':' .. (ipbits_client[3] or "0000") .. ':' ..
                (ipbits_client[4] or "0000") .. ':' ..
                (ipbits_client[5] or "0000") .. ':' ..
                (ipbits_client[6] or "0000") .. ':' ..
                (ipbits_client[7] or "0000") .. ':' ..
                (ipbits_client[8] or "0000")
        client_connecting_ip_count = ngx.re.gsub(client_connecting_ip_count,
                                                 ":", "", ngx_re_options)
        ...
        client_connecting_ip_count = string.sub(client_connecting_ip_count, 0,
                                                indent)

        local client_connecting_ip_expanded = ngx.re.gsub(
                                                  client_connecting_ip_count,
                                                  "....", "%1:", ngx_re_options)
        client_connecting_ip_expanded = ngx.re.gsub(client_connecting_ip_count,
                                                    ":$", "", ngx_re_options)
        local expanded_ip = ngx.re.gsub(expanded_ip_count, "....", "%1:",
                                        ngx_re_options)
    ...
    if ip_type == 2 then -- ipv4
        ...
        local a, b, ip1, ip2, ip3, ip4, mask = input_ip:find(
                                                   '(%d+).(%d+).(%d+).(%d+)/(%d+)')
        local ip = {tonumber(ip1), tonumber(ip2), tonumber(ip3), tonumber(ip4)}
        local a, b, client_ip1, client_ip2, client_ip3, client_ip4 =
            client_connecting_ip:find('(%d+).(%d+).(%d+).(%d+)')
        local client_ip = {
            tonumber(client_ip1), tonumber(client_ip2), tonumber(client_ip3),
            tonumber(client_ip4)
        }
        ...
        local isnetworkip = (ip[1] == bottomip[1] and ip[2] == bottomip[2] and
                                ip[3] == bottomip[3] and ip[4] == bottomip[4])
        local isbroadcastip =
            (ip[1] == topip[1] and ip[2] == topip[2] and ip[3] == topip[3] and
                ip[4] == topip[4])
        ...
        if tonumber(mask) == 1 then -- 127, 255, 255, 255
            ...
            and client_ip1 <= in_range_top_end1 and client_ip2 >=
                in_range_low_end2 -- in range low end
            and client_ip2 <= in_range_top_end2 and client_ip3 >=
                in_range_low_end3 -- in range low end
            and client_ip3 <= in_range_top_end3 and client_ip4 >=
                in_range_low_end4 -- in range low end
        ...
        if tonumber(mask) == 8 then -- 0, 255, 255, 255
            if ip1 == client_ip1 and client_ip2 >= in_range_low_end2 -- in range low end
            and client_ip2 <= in_range_top_end2 and client_ip3 >=
                in_range_low_end3 -- in range low end
            and client_ip3 <= in_range_top_end3 and client_ip4 >=
                in_range_low_end4 -- in range low end
        ...
        if tonumber(mask) == 16 then -- 0, 0, 255, 255
            if ip1 == client_ip1 and ip2 == client_ip2 and client_ip3 >=
                in_range_low_end3 -- in range low end
            and client_ip3 <= in_range_top_end3 and client_ip4 >=
                in_range_low_end4 -- in range low end
            and client_ip4 <= in_range_top_end4 then -- in range top end
        ...
        if tonumber(mask) == 24 then -- 0, 0, 0, 255
            if ip1 == client_ip1 and ip2 == client_ip2 and ip3 == client_ip3 and
                client_ip4 >= in_range_low_end4 -- in range low end
            and client_ip4 <= in_range_top_end4 then -- in range top end
                return true
            end
        end
        ...
        if next(argument_request_headers) ~= nil then -- Check Header args table has contents	
            ...
            for key, value in next, argument_request_headers do
                ...
                for i = 1, WAF_table_length do
                    ...
                    local args_value =
                        tostring(ngx.req.get_headers()[args_name]) or ""
        ...
        if next(args) ~= nil then -- Check query string args table has contents
            ...
            for key, value in next, args do
                ...
                for i = 1, WAF_table_length do
                    ...
                    local args_value = tostring(
                                           ngx.req.get_uri_args()[args_name]) or
                                           "" -- variable to store query string data argument value
                    if string.match(args_name, argument_name) then -- if the argument name in my table matches the one in the request
                        arguement1 = 1
                    end
                    if string.match(args_value, argument_value) then -- if the argument value in my table matches the one the request
...
local function stringrandom(length)
    -- math.randomseed(os.time())
    if length > 0 then
        local output = stringrandom(length - 1) ..
                           charset[math.random(1, #charset)]
        ...
        for i = 1, stringrandom_table_length do -- for each value in our generated var table
            if stringrandom_table[i] == output then -- if a value in our table matches our generated var
                ...
                stringrandom_table_new_length =
                    stringrandom_table_new_length + 1
...
if dynamic_javascript_vars_length == 1 then -- if our javascript random var length is to be static
    ...
    stringrandom_length = math.random(dynamic_javascript_vars_length_start,
                                      dynamic_javascript_vars_length_end) -- set our length to be our dynamic min and max value
end
...
local function encrypt_javascript(string1, type, defer_async, num_encrypt,
                                  encrypt_type, methods) -- Function to generate encrypted/obfuscated output
    ...
    if type == 1 or type == nil then -- No encryption
        if defer_async == "0" or defer_async == nil then -- Browser default loading / execution order
            output = "<script type=\"text/javascript\" charset=\"" ..
                         default_charset .. "\" data-cfasync=\"false\">" ..
                         string1 .. "</script>"
        end
        if defer_async == "1" then -- Defer
            output =
                "<script type=\"text/javascript\" defer=\"defer\" charset=\"" ..
                    default_charset .. "\" data-cfasync=\"false\">" .. string1 ..
                    "</script>"
        end
        if defer_async == "2" then -- Async
            output =
                "<script type=\"text/javascript\" async=\"async\" charset=\"" ..
                    default_charset .. "\" data-cfasync=\"false\">" .. string1 ..
                    "</script>"
        end
    end
    ...
    if type == 2 then -- Base64 Data URI
        ...
        if defer_async == "0" or defer_async == nil then -- Browser default loading / execution order
            output =
                "<script type=\"text/javascript\" src=\"data:text/javascript;base64," ..
                    ngx.encode_base64(string1) .. "\" charset=\"" ..
                    default_charset .. "\" data-cfasync=\"false\"></script>"
        end
        if defer_async == "1" then -- Defer
            output =
                "<script type=\"text/javascript\" src=\"data:text/javascript;base64," ..
                    ngx.encode_base64(string1) ..
                    "\" defer=\"defer\" charset=\"" .. default_charset ..
        ...
        if defer_async == "2" then -- Async
            output =
                "<script type=\"text/javascript\" src=\"data:text/javascript;base64," ..
                    ngx.encode_base64(string1) ..
                    "\" async=\"async\" charset=\"" .. default_charset ..
                    "\" data-cfasync=\"false\"></script>"
        end
    end
    ...
    if type == 3 then -- Hex
        ...
        if tonumber(encrypt_type) == 2 then
            hexadecimal_x = string.char(92) .. "x" ..
                                sep(hex_output, "%x%x", string.char(92) .. "x") -- hex output insert a char every 2 chars %x%x
        end
        ...
        if defer_async == "0" or defer_async == nil then -- Browser default loading / execution order
            ...
            output = "<script type=\"text/javascript\" charset=\"" ..
                         default_charset ..
                         "\" data-cfasync=\"false\">eval(decodeURIComponent(escape('" ..
                         hexadecimal_x .. "')));</script>"
        end
        if defer_async == "1" then -- Defer
            output =
                "<script type=\"text/javascript\" defer=\"defer\" charset=\"" ..
    ...
    if type == 4 then -- Base64 javascript decode
        ...
        if tonumber(num_encrypt) ~= nil then -- If number of times extra to rencrypt is set
            for i = 1, num_encrypt do -- for each number
                base64_javascript =
                    "eval(decodeURIComponent(escape(window.atob('" ..
                        ngx.encode_base64(base64_javascript) .. "'))))"
            end
        end
    ...
    if type == 5 then -- Conor Mcknight's Javascript Scrambler (Obfuscate Javascript by putting it into vars and shuffling them like a deck of cards)
        ...
        while i <= l do
            ...
            chunks[chunks_table_length] =
                'var _' .. random_var .. '="' .. base64_javascript:sub(i, i + r) ..
                    '";' -- insert our value into our table we will scramble
        ...
        output = output .. "eval(decodeURIComponent(escape(window.atob(" ..
                     table.concat(chunks_order, " + ") .. "))));" -- put our scrambled table and ordered table into a string
        ...
        if defer_async == "1" then -- Defer
            output =
                "<script type=\"text/javascript\" defer=\"defer\" charset=\"" ..
                    default_charset .. "\" data-cfasync=\"false\">" .. output ..
                    "</script>"
        end
        if defer_async == "2" then -- Defer
            output =
...
local cookie_name_encrypted_start_and_end_date_original =
...
if x_tor_header == 2 then -- if x-tor-header is dynamic
    x_tor_header_name = calculate_signature(
                            tor_remote_addr .. x_tor_header_name .. currentdate) -- make the header unique to the client and for todays date encrypted so every 24 hours this will change and can't be guessed by bots gsub because header bug with underscores so underscore needs to be removed
    x_tor_header_name = ngx.re.gsub(x_tor_header_name, "_", "", ngx_re_options) -- replace underscore with nothing
    x_tor_header_name_allowed = calculate_signature(tor_remote_addr ..
                                                        x_tor_header_name_allowed ..
                                                        currentdate) -- make the header unique to the client and for todays date encrypted so every 24 hours this will change and can't be guessed by bots gsub because header bug with underscores so underscore needs to be removed
    x_tor_header_name_allowed = ngx.re.gsub(x_tor_header_name_allowed, "_", "",
                                            ngx_re_options) -- replace underscore with nothing
    x_tor_header_name_blocked = calculate_signature(tor_remote_addr ..
                                                        x_tor_header_name_blocked ..
                                                        currentdate) -- make the header unique to the client and for todays date encrypted so every 24 hours this will change and can't be guessed by bots gsub because header bug with underscores so underscore needs to be removed
    x_tor_header_name_blocked = ngx.re.gsub(x_tor_header_name_blocked, "_", "",
                                            ngx_re_options) -- replace underscore with nothing
end

if encrypt_anti_ddos_cookies == 2 then -- if Anti-DDoS Cookies are to be encrypted
    cookie_tor = calculate_signature(tor_remote_addr .. cookie_tor ..
                                         currentdate) -- encrypt our tor cookie name
    cookie_tor_value_allow = calculate_signature(tor_remote_addr ..
                                                     cookie_tor_value_allow ..
                                                     currentdate) -- encrypt our tor cookie value for allow
    cookie_tor_value_block = calculate_signature(tor_remote_addr ..
                                                     cookie_tor_value_block ..
                                                     currentdate) -- encrypt our tor cookie value for block
end
...
if encrypt_anti_ddos_cookies == 2 then -- if Anti-DDoS Cookies are to be encrypted
    authorization_cookie = calculate_signature(remote_addr ..
                                                   authorization_cookie ..
                                                   currentdate) -- encrypt our auth box session cookie name
end
...
local function check_authorization(authorization, authorization_dynamic)
    ...
    if authorization == 2 then -- Cookie sessions
        ...
        expected_cookie_value = calculate_signature(remote_addr ..
                                                        "authenticate" ..
                                                        currentdate) -- encrypt our expected cookie value
    ...
    if authorization_dynamic == 0 then -- static
        ...
        for i = 1, authorization_logins_length do -- for each login
            ...
            local base64_expected = authorization_username .. ":" ..
                                        authorization_password -- convert to browser format
            ...
            if req_headers["Authorization"] == authroization_user_pass then -- if the details match what we expect
                if authorization == 2 then -- Cookie sessions
                    set_cookie1 = authorization_cookie .. "=" ..
                                      expected_cookie_value ..
                                      "; path=/; expires=" ..
                                      ngx.cookie_time(currenttime + expire_time) ..
                                      "; Max-Age=" .. expire_time .. ";"
    ...
    if authorization_dynamic == 1 then -- dynamic
        authorization_username = calculate_signature(
                                     remote_addr .. "username" .. currentdate) -- encrypt username
        authorization_password = calculate_signature(
                                     remote_addr .. "password" .. currentdate) -- encrypt password
        authorization_username = string.sub(authorization_username, 1,
                                            authorization_dynamic_length) -- change username to set length
        authorization_password = string.sub(authorization_password, 1,
                                            authorization_dynamic_length) -- change password to set length
        ...
        if req_headers["Authorization"] == authroization_user_pass then -- if the details match what we expect
            if authorization == 2 then -- Cookie sessions
                set_cookie1 = authorization_cookie .. "=" ..
                                  expected_cookie_value .. "; path=/; expires=" ..
                                  ngx.cookie_time(currenttime + expire_time) ..
                                  "; Max-Age=" .. expire_time .. ";"
                set_cookies = {set_cookie1}
                ngx.header["Set-Cookie"] = set_cookies -- send client a cookie for their session to be valid
    ...
    if allow_access == 1 then
        ...
        if authorization_display_user_details == 0 then
            ...
            ngx.header['WWW-Authenticate'] = 'Basic realm="' ..
                                                 authorization_message .. ' ' ..
                                                 authorization_username_message ..
...
if x_auth_header == 2 then -- if x-auth-header is dynamic
    x_auth_header_name = calculate_signature(
                             remote_addr .. x_auth_header_name .. currentdate) -- make the header unique to the client and for todays date encrypted so every 24 hours this will change and can't be guessed by bots gsub because header bug with underscores so underscore needs to be removed
    x_auth_header_name = ngx.re
                             .gsub(x_auth_header_name, "_", "", ngx_re_options) -- replace underscore with nothing
end
...
if encrypt_anti_ddos_cookies == 2 then -- if Anti-DDoS Cookies are to be encrypted
    ...
    cookie_name_start_date = calculate_signature(remote_addr ..
                                                     cookie_name_start_date ..
                                                     currentdate)
    cookie_name_end_date = calculate_signature(remote_addr ..
                                                   cookie_name_end_date ..
                                                   currentdate)
    cookie_name_encrypted_start_and_end_date =
        calculate_signature(remote_addr ..
                                cookie_name_encrypted_start_and_end_date ..
                                currentdate)
end
...
local function grant_access()
    ...
    local cookie_name_start_date_value =
        ngx.var[cookie_name_start_date_name] or ""
    local cookie_name_start_date_value_unix = tonumber(
                                                  cookie_name_start_date_value)
    -- our end date cookie
    ...
    local cookie_name_encrypted_start_and_end_date_name = "cookie_" ..
                                                              cookie_name_encrypted_start_and_end_date
    local cookie_name_encrypted_start_and_end_date_value =
        ngx.var[cookie_name_encrypted_start_and_end_date_name] or ""
    ...
    if req_headers["x-requested-with"] == "XMLHttpRequest" then -- if request header matches request type of XMLHttpRequest
        if req_headers[x_tor_header_name] == x_tor_header_name_value and
            req_headers[x_auth_header_name] == JavascriptPuzzleVars_answer then -- if the header and value are what we expect then the client is legitimate
            remote_addr = tor_remote_addr -- set as our defined static tor variable to use

            challenge = calculate_signature(
                            remote_addr .. challenge_original .. currentdate) -- create our encrypted unique identification for the user visiting the website again. (Stops a double page refresh loop)
            ...
            cookie_name_start_date = calculate_signature(remote_addr ..
                                                             cookie_name_start_date_original ..
                                                             currentdate) -- create our cookie_name_start_date again under the new remote_addr (Stops a double page refresh loop)
            cookie_name_end_date = calculate_signature(remote_addr ..
                                                           cookie_name_end_date_original ..
                                                           currentdate) -- create our cookie_name_end_date again under the new remote_addr (Stops a double page refresh loop)
            cookie_name_encrypted_start_and_end_date =
                calculate_signature(remote_addr ..
                                        cookie_name_encrypted_start_and_end_date_original ..
                                        currentdate) -- create our cookie_name_encrypted_start_and_end_date again under the new remote_addr (Stops a double page refresh loop)

            set_cookie1 = challenge .. "=" .. answer .. "; path=/; expires=" ..
                              ngx.cookie_time(currenttime + expire_time) ..
                              "; Max-Age=" .. expire_time .. ";" -- apply our uid cookie incase javascript setting this cookies time stamp correctly has issues
            set_cookie2 = cookie_name_start_date .. "=" .. currenttime ..
                              "; path=/; expires=" ..
                              ngx.cookie_time(currenttime + expire_time) ..
                              "; Max-Age=" .. expire_time .. ";" -- start date cookie
            set_cookie3 = cookie_name_end_date .. "=" ..
                              (currenttime + expire_time) ..
                              "; path=/; expires=" ..
                              ngx.cookie_time(currenttime + expire_time) ..
                              "; Max-Age=" .. expire_time .. ";" -- end date cookie
            set_cookie4 = cookie_name_encrypted_start_and_end_date .. "=" ..
                              calculate_signature(
                                  remote_addr .. currenttime ..
                                      (currenttime + expire_time)) ..
                              "; path=/; expires=" ..
                              ngx.cookie_time(currenttime + expire_time) ..
                              "; Max-Age=" .. expire_time .. ";" -- start and end date combined to unique id
            set_cookie5 = cookie_tor .. "=" .. cookie_tor_value ..
                              "; path=/; expires=" ..
                              ngx.cookie_time(currenttime + expire_time) ..
                              "; Max-Age=" .. expire_time .. ";" -- create our tor cookie to identify the client as a tor user

            set_cookies = {
                set_cookie1, set_cookie2, set_cookie3, set_cookie4, set_cookie5
            }
        ...
        if req_headers[x_auth_header_name] == JavascriptPuzzleVars_answer then -- if the answer header provided by the browser Javascript matches what our Javascript puzzle answer should be
            set_cookie1 = challenge .. "=" .. cookie_value ..
                              "; path=/; expires=" ..
                              ngx.cookie_time(currenttime + expire_time) ..
                              "; Max-Age=" .. expire_time .. ";" -- apply our uid cookie incase javascript setting this cookies time stamp correctly has issues
            set_cookie2 = cookie_name_start_date .. "=" .. currenttime ..
    ...
    if cookie_name_start_date_value ~= nil and cookie_name_end_date_value ~= nil and
        cookie_name_encrypted_start_and_end_date_value ~= nil then -- if all our cookies exist
        local cookie_name_end_date_value_unix = tonumber(
                                                    cookie_name_end_date_value) or
                                                    nil -- convert our cookie end date provided by the user into a unix time stamp
        if cookie_name_end_date_value_unix == nil or
            cookie_name_end_date_value_unix == "" then -- if our cookie end date date in unix does not exist
            return -- return to refresh the page so it tries again
        end
        ...
        if cookie_name_encrypted_start_and_end_date_value ~=
            calculate_signature(
                remote_addr .. cookie_name_start_date_value_unix ..
                    cookie_name_end_date_value_unix) then -- if users authentication encrypted cookie not equal to or matching our expected cookie they should be giving us
            return -- return to refresh the page so it tries again
        end
    end
...
if (v == true) {
	xhttp.setRequestHeader(']] .. x_tor_header_name .. [[', ']] ..
                                  x_tor_header_name_value .. [[');
}
]]
--[[
...
xhttp.setRequestHeader(']] .. x_auth_header_name .. [[', ]] ..
                                       JavascriptPuzzleVariable_name ..
                                       [[); //make the answer what ever the browser figures it out to be
...
(function(){
	...
	b(function(){
		...
		setTimeout(function(){
			...
			time += 300 * 1000;
			now.setTime(time);
			document.cookie = ']] .. challenge .. [[=]] .. answer ..
                                 [[' + '; expires=' + ']] ..
                                 ngx.cookie_time(currenttime + expire_time) ..
                                 [[' + '; path=/';
			...
			xhttp.open("]] .. javascript_REQUEST_TYPE .. [[", "]] .. request_uri ..
                                 [[", true);
			]] .. javascript_REQUEST_headers .. [[
			]] .. javascript_POST_headers .. [[
			xhttp.send(]] .. javascript_POST_data .. [[);
		}, ]] .. refresh_auth + 1 ..
                                 [[000); /*if correct data has been sent then the auth response will allow access*/
	}, false);
})();
]]
...
if encrypt_javascript_output == 1 then -- No encryption/Obfuscation of Javascript so show Javascript in plain text
    javascript_anti_ddos = [[<script type="text/javascript" charset="]] ..
                               default_charset .. [[" data-cfasync="false">
]] .. javascript_anti_ddos .. [[
</script>]]
else -- some form of obfuscation has been specified so obfuscate the javascript output
    javascript_anti_ddos = encrypt_javascript(javascript_anti_ddos,
                                              encrypt_javascript_output) -- run my function to encrypt/obfuscate javascript output
end
...
if set_cookies == nil then
    set_cookies = challenge .. "=" .. answer .. "; path=/; expires=" ..
                      ngx.cookie_time(currenttime + expire_time) .. "; Max-Age=" ..
                      expire_time .. ";" -- apply our uid cookie in header here incase browsers javascript can't set cookies due to permissions.
end
ngx.header["Set-Cookie"] = set_cookies
ngx.header["X-Content-Type-Options"] = "nosniff"
ngx.header["X-Frame-Options"] = "SAMEORIGIN"
...
ngx.header["Pragma"] = "no-cache"
ngx.header["Expires"] = "0"
if credits == 1 then ngx.header["X-Anti-DDoS"] = "CloudDream" end
ngx.header.content_type = "text/html; charset=" .. default_charset
